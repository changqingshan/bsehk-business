package com.bsehk.business.biz.feign;

import com.bsehk.business.biz.config.FeignMultipartSupportConfig;
...
@FeignClient(name="bsehk-file-service",fallbackFactory = FileServiceFallBackFactory.class,
